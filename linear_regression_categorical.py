...
def main(argv):
  ...
  pf_category_column = tf.feature_column.categorical_column_with_hash_bucket(
      key="pf_category", hash_bucket_size=50)
  office_id_column = tf.feature_column.categorical_column_with_hash_bucket(
      key="office_id", hash_bucket_size=50)
