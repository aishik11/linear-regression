...
def _get_imports85():
  ...
  with open("train.csv",'r') as f:
    with open("trainf.csv",'w') as f1:
        next(f) # skip header line
        for line in f:
            f1.write(line)

  path= os.getcwd()+"\\trainf.csv"
  return path


def dataset(y_name="return", train_fraction=0.7):
...
def load_data(y_name="return", train_fraction=0.7, seed=None):
